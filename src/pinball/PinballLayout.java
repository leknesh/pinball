...
public class PinballLayout {
    ...
    public void getLayout(Group objects, Group lines, Group circles, Group arcs, Group rectangles) {
        ...
        lTriangleRight1.setStroke(Color.BLUE);
        lTriangleRight1.setStrokeWidth(3);
        ...
        lTriangleRight2.setStroke(Color.BLUE);
        lTriangleRight2.setStrokeWidth(3);
        ...
        lTriangleRight3.setStroke(Color.BLUE);
        lTriangleRight3.setStrokeWidth(3);
        ...
        lFlipperLeft3.setStroke(Color.RED);
        lFlipperLeft3.setStrokeWidth(5);
        objects.getChildren().add(lFlipperLeft3);
        lines.getChildren().add(lFlipperLeft3);
        
        Line1 lFlipperRight3 = new Line1(265, 490, 320, 477);
        lFlipperRight3.setStroke(Color.RED);
        lFlipperRight3.setStrokeWidth(5);
